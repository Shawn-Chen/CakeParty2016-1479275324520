...
$(document).ready(function () {
  var $chat_blue = $('#q4 .label-blue'),
    $chat_red = $('#q4 .label-red'),
    $question = $('#q4 p.question'),
    $blue_percentage = $('#q4 .blue-percentage'),
    $red_percentage = $('#q4 .red-percentage'),
    $play_btn = $('#q4 .glyphicon-play-circle'),
    $micButtonBlue = $('#q4 .btn-blue'),
    $micButtonBlueFinish = $('#q4 .btn-blue-finish'),
    $micButtonRed = $('#q4 .btn-red'),
    $micButtonRedFinish = $('#q4 .btn-red-finish');
  ...
  function record_blue() {
    getSTTToken.then(function(token) {
      ...
      document.querySelector('#q4 .btn-blue-finish').onclick = function(){
        //console.log(stream);
        stream.stop();
  ...
  function record_red() {
    getSTTToken.then(function(token) {
      ...
      document.querySelector('#q4 .btn-red-finish').onclick = function(){
        //console.log(stream);
        stream.stop();
