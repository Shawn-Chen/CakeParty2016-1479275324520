...
$(document).ready(function () {
  var $chat_blue = $('#q11 .label-blue'),
    $chat_red = $('#q11 .label-red'),
    $question = $('#q11 p.question'),
    $blue_percentage = $('#q11 .blue-percentage'),
    $red_percentage = $('#q11 .red-percentage'),
    $play_btn = $('#q11 .glyphicon-play-circle'),
    $micButtonBlue = $('#q11 .btn-blue'),
    $micButtonBlueFinish = $('#q11 .btn-blue-finish'),
    $micButtonRed = $('#q11 .btn-red'),
    $micButtonRedFinish = $('#q11 .btn-red-finish');
  ...
  function record_blue() {
    getSTTToken.then(function(token) {
      ...
      document.querySelector('#q11 .btn-blue-finish').onclick = function(){
        //console.log(stream);
        stream.stop();
  ...
  function record_red() {
    getSTTToken.then(function(token) {
      ...
      document.querySelector('#q11 .btn-red-finish').onclick = function(){
        //console.log(stream);
        stream.stop();
