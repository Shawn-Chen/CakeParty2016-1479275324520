...
$(document).ready(function () {
  var $chat_blue = $('#q1 .label-blue'),
    $chat_red = $('#q1 .label-red'),
    ...
    $micButtonRedFinish = $('#q1 .btn-red-finish');
  ...
  function record_blue() {
    getSTTToken.then(function(token) {
      ...
      document.querySelector('#q1 .btn-blue-finish').onclick = function(){
        //console.log(stream);
        stream.stop();
  ...
  function record_red() {
    getSTTToken.then(function(token) {
      ...
      document.querySelector('#q1 .btn-red-finish').onclick = function(){
        //console.log(stream);
        stream.stop();
